...
namespace Pizzatron
{
	public class mg_pt_ToppingBar : MonoBehaviour
	{
		...
		public void Initialize(mg_pt_GameLogic p_gameLogic)
		{
			...
			m_inputManager = gameObject.AddComponent<mg_pt_InputManager>();
			m_inputManager.Initialize(p_gameLogic.Minigame.MainCamera, this);
			Initialize_Holders();
		...
		{
			// Replace m_inputManager.TidyUp(); with Destroy(m_inputManager);
