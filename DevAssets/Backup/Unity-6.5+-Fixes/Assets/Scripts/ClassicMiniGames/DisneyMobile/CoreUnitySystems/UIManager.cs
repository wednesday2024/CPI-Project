...
namespace DisneyMobile.CoreUnitySystems
{
	public class UIManager : MonoBehaviour
	{
		...
		private void Update()
		{
			// Use the new Input System for Escape key detection.
			// Only check if not on iPhonePlayer platform.
			if (Application.platform != RuntimePlatform.IPhonePlayer && Keyboard.current != null && Keyboard.current.escapeKey.wasReleasedThisFrame)
			{
