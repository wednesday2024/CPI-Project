...
public class EasyJoystick : MonoBehaviour
{
    ...
    {
        // Subscribe to SceneManager.sceneLoaded to replace deprecated OnLevelWasLoaded
    ...
    {
        // Unsubscribe the SceneManager handler
        SceneManager.sceneLoaded -= OnSceneLoaded;
    ...
    // Replacement for deprecated OnLevelWasLoaded
