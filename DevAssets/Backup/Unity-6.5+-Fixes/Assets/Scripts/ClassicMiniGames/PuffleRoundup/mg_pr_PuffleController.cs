...
namespace PuffleRoundup
{
	public class mg_pr_PuffleController : MonoBehaviour
	{
		...
		{
			var activeMinigame = MinigameManager.GetActive();
			if (activeMinigame == null)
			{
				Debug.LogWarning("[PlayAudio] MinigameManager.GetActive() returned null - cannot play sound: " + sound);
				return;
			}
			...
			if (sound == "move")
			{
				...
				{
					case 1:
						activeMinigame.PlaySFX("mg_pr_sfx_move1");
						break;
					case 2:
						activeMinigame.PlaySFX("mg_pr_sfx_move2");
						break;
					case 3:
						activeMinigame.PlaySFX("mg_pr_sfx_move3");
						break;
				}
			}
			if (sound == "fail")
			{
				...
				{
					case 1:
						activeMinigame.PlaySFX("mg_pr_sfx_fail1");
						break;
					case 2:
						activeMinigame.PlaySFX("mg_pr_sfx_fail2");
						break;
					case 3:
						activeMinigame.PlaySFX("mg_pr_sfx_fail3");
						break;
				}
			}
			if (sound == "success")
			{
				...
				{
					case 1:
						activeMinigame.PlaySFX("mg_pr_sfx_success1");
						break;
					case 2:
						activeMinigame.PlaySFX("mg_pr_sfx_success2");
						break;
					case 3:
						activeMinigame.PlaySFX("mg_pr_sfx_success3");
						break;
				}
			}
		}
