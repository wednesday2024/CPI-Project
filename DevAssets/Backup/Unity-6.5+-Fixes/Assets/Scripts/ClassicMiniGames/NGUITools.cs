...
public static class NGUITools
{
    ...
    public static AudioSource PlaySound(AudioClip clip, float volume, float pitch)
    {
        ...
        if (clip != null && volume > 0.01f)
        {
            ...
            {
                AudioListener[] array = UnityEngine.Object.FindObjectsByType<AudioListener>();
                if (array != null)
                {
    ...
    public static UnityWebRequest OpenURL(string url)
    {
        UnityWebRequest result = null;
        try
        {
            result = UnityWebRequest.Get(url);
            result.SendWebRequest();
        }
        catch (Exception ex)
        {
    ...
    public static UnityWebRequest OpenURL(string url, WWWForm form)
    {
        if (form == null)
        {
            return OpenURL(url);
        ...
        try
        {
            result = UnityWebRequest.Post(url, form);
            result.SendWebRequest();
        }
        catch (Exception ex)
        {
    ...
    {
        GameObject[] array = UnityEngine.Object.FindObjectsByType<GameObject>();
        int i = 0;
