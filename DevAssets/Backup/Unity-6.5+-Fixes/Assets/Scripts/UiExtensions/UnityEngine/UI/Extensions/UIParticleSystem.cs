    ...
    public class UIParticleSystem : MaskableGraphic
    {
        ...
        protected bool Initialize()
        {
            ...
            if (_textureSheetAnimation.enabled)
            {
                ...
                _textureSheedAnimationFrameSize = new Vector2(
                    1f / (float)_textureSheetAnimation.numTilesX,
                    1f / (float)_textureSheetAnimation.numTilesY
                );
            }
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            for (int i = 0; i < particles; i++)
            {
                ...
                Vector2 a = (_particleSystem.main.simulationSpace != ParticleSystemSimulationSpace.World)
