...
namespace ClubPenguin.UI
{
	public class DailySpinRewardPopup : MonoBehaviour
	{
		...
		private const string PARTY_BLASTER_TEXT_TOKEN = "Prop_Mega_Party_Blaster";
		...
		public void ShowReward(Reward spinReward, bool isRespin)
		{
			...
			if (spinReward.TryGetValue(out rewardable))
			{
                ...
                else
                {
                    ...
                    CoinsText.text = localizer.GetTokenTranslation("Prop_Mega_Party_Blaster");
                    CoinsText.gameObject.SetActive(true);
                }
            }
