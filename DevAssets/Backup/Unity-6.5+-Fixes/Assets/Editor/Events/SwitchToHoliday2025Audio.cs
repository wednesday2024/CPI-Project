...
public class SwitchToHoliday2025Audio : MonoBehaviour
{
    [MenuItem("Project/Events/Holiday 2025/Switch to the Holiday 2025 Audio")]
    ...
    private static void ModifySceneAudioPath(string scenePath)
    {
        ...
        if (scene != null)
        {
            ...
            string newAudioPath = $"Audio/TemporaryContent/HolidayParty_2025/{sceneName}/Audio.{sceneName}";
