...
{
    [MenuItem("Project/Generate lighting/Lightmap baking/Events/Pirate Expedition Boardwalk")]
    ...
    static void BakePirateExpeditionBoardwalk()
    {
        ...
        if (activeScene.IsValid())
        {
            ...
            if (targetObject != null)
            {
                ...
                string FolderPath = "Assets/Game/World/Scenes/Events/PirateParty2018/Resources/AdditiveScenes/EventPirateParty2018_Boardwalk_Decorations";
