...
public class SuperTrampoline : MonoBehaviour
{
    ...
    private int tweakerSimulatedPenguinCount;
    ...
    public int TweakerGetSimulatedPenguinCount()
    {
        return tweakerSimulatedPenguinCount;
    }

    public void TweakerSetSimulatedPenguinCount(int count)
    {
        if (count < 0)
        {
            count = 0;
        }
        int num = count - tweakerSimulatedPenguinCount;
        tweakerSimulatedPenguinCount = count;
        if (num != 0)
        {
            updateTeamworkLevel(teamworkDelta * (float)num);
        }
    }
