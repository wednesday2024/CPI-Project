...
public class mg_pt_GameScreen : MinigameScreen
{
    ...
    {
        Vector2 gameSize = new Vector2(1364f, 768f) / 100f;
        float screenWidth = m_logic.Minigame.MainCamera.orthographicSize * 2f * m_logic.Minigame.MainCamera.aspect;
        float scaleX = screenWidth / gameSize.x;
        m_game.transform.localScale = new Vector3(scaleX, scaleX, 1f);
