...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ToolTip : MonoBehaviour
    {
        ...
        {
            // Use UnityEngine.InputSystem for mouse position
            Vector3 mousePosition = Mouse.current != null
                ? (Vector3)Mouse.current.position.ReadValue()
                : Vector3.zero;
            Vector3 position = _guiCamera.ScreenToViewportPoint(mousePosition - new Vector3(xShift, YShift, 0f));
