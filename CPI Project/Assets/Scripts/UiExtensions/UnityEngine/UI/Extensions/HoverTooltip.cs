...
namespace UnityEngine.UI.Extensions
{
    ...
    public class HoverTooltip : MonoBehaviour
    {
        ...
        public void OnScreenSpaceCamera()
        {
            ...
            Vector3 position = GUICamera.ScreenToViewportPoint(mousePosition);
            float num = 0f;
            float num2 = 0f;
            ...
            if (num4 > upperRight.x)
            {
                ...
                num2 = ((num5 > defaultXOffset * 0.75f) ? num5 : (defaultXOffset - tooltipRealWidth * 2f));
            ...
            if (num4 < lowerLeft.x)
            {
                ...
                num2 = ((num7 < defaultXOffset * 0.75f - tooltipRealWidth) ? (0f - num7) : (tooltipRealWidth * 2f));
            ...
            if (num4 > upperRight.y)
            {
                ...
                num = num10 * pivot4.y;
                num = ((num9 > defaultYOffset * 0.75f) ? num9 : (defaultYOffset - tooltipRealHeight * 2f));
                float x3 = position.x;
            ...
            if (num4 < lowerLeft.y)
            {
                ...
                num = num13 * pivot6.y;
                num = ((num12 < defaultYOffset * 0.75f - tooltipRealHeight) ? num12 : (tooltipRealHeight * 2f));
                float x4 = position.x;
