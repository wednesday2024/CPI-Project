...
namespace ClubPenguin.Props
{
	...
	public class Prop : MonoBehaviour
	{
		...
		{
			if (!string.IsNullOrEmpty(name) && EventManager.Instance != null)
			{
				SoundUtils.PlayAudioEvent(name, gameObject);
			}
		}
		...
		public void FabricPauseSound(string name)
		{
			if (!string.IsNullOrEmpty(name) && EventManager.Instance != null)
			{
				SoundUtils.PostAudioEvent(name, EventAction.PauseSound, null, gameObject);
			}
		}
		...
		public void FabricUnpauseSound(string name)
		{
			if (!string.IsNullOrEmpty(name) && EventManager.Instance != null)
			{
				SoundUtils.PostAudioEvent(name, EventAction.UnpauseSound, null, gameObject);
			}
		}
		...
		public void FabricStopSound(string name)
		{
			if (!string.IsNullOrEmpty(name) && EventManager.Instance != null)
			{
				SoundUtils.PostAudioEvent(name, EventAction.StopSound, null, gameObject);
			}
		}
		...
		public void FabricSetVolume(string name, float volume)
		{
			if (!string.IsNullOrEmpty(name) && EventManager.Instance != null)
			{
				SoundUtils.PostAudioEvent(name, EventAction.SetVolume, volume, gameObject);
			}
		}
		...
		public void FabricSetPitch(string name, float pitch)
		{
			if (!string.IsNullOrEmpty(name) && EventManager.Instance != null)
			{
				SoundUtils.PostAudioEvent(name, EventAction.SetPitch, pitch, gameObject);
			}
		}
		...
		public void OnPropAction(string action)
		{
		...
		public void PerformAction(string action)
		{
			...
			try
			{
				...
				PlayMakerFSM[] fsms = GetComponentsInChildren<PlayMakerFSM>();
				...
				foreach (PlayMakerFSM fsm in fsms)
				{
					...
					if (string.Equals(normalizedAction, "Action1", StringComparison.OrdinalIgnoreCase) ||
						string.Equals(normalizedAction, "PropTriggerAction1", StringComparison.OrdinalIgnoreCase) ||
						string.Equals(normalizedAction, "Action1AnimationTrigger", StringComparison.OrdinalIgnoreCase))
					{
						soundEventName = fsm.FsmVariables.GetFsmString("Action1SoundEventName")?.Value;
					}
					else if (string.Equals(normalizedAction, "Action2", StringComparison.OrdinalIgnoreCase) ||
						string.Equals(normalizedAction, "PropTriggerAction2", StringComparison.OrdinalIgnoreCase) ||
						string.Equals(normalizedAction, "Action2AnimationTrigger", StringComparison.OrdinalIgnoreCase))
					{
						soundEventName = fsm.FsmVariables.GetFsmString("Action2SoundEventName")?.Value;
					}
					else if (string.Equals(normalizedAction, "Action3", StringComparison.OrdinalIgnoreCase) ||
						string.Equals(normalizedAction, "PropTriggerAction3", StringComparison.OrdinalIgnoreCase) ||
						string.Equals(normalizedAction, "Action3AnimationTrigger", StringComparison.OrdinalIgnoreCase))
					{
						soundEventName = fsm.FsmVariables.GetFsmString("Action3SoundEventName")?.Value;
					}
					else
					{
					}
				...
				if (!string.IsNullOrEmpty(soundEventName))
				{
					FabricPlaySound(soundEventName);
				}
				else
				{
				}
