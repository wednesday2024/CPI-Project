...
namespace ClubPenguin
{
	public class PlayerSpawnPositionManager : MonoBehaviour
	{
		...
		private bool spawnNearTransition(ZoneDefinition previousZone)
		{
			...
			ZoneTransition[] array = Object.FindObjectsByType<ZoneTransition>(FindObjectsSortMode.None);
			...
			{
				MapTransition mapTransition = Object.FindFirstObjectByType<MapTransition>();
		...
		{
			bool result = false;
			SpawnPointSelector spawnPointSelector = Object.FindFirstObjectByType<DefaultSpawnPointSelector>();
