	...
	public class EquipmentShaderParams
	{
		...
		public void ApplyToMaterial(Material material)
		{
			...
			if (material.shader.name == "CpRemix/Equipment Preview" || material.shader.name == "CpRemix/Equipment Bake")
			{
				...
				material.SetFloat(DECAL_RED_1_REPEAT, (!DecalRed1Repeat) ? 0f : 1f);
				...
				material.SetFloat(DECAL_GREEN_2_REPEAT, (!DecalGreen2Repeat) ? 0f : 1f);
				...
				material.SetFloat(DECAL_BLUE_3_REPEAT, (!DecalBlue3Repeat) ? 0f : 1f);
				...
				material.SetFloat(DECAL_RED_4_REPEAT, (!DecalRed4Repeat) ? 0f : 1f);
				...
				material.SetFloat(DECAL_GREEN_5_REPEAT, (!DecalGreen5Repeat) ? 0f : 1f);
				...
				material.SetFloat(DECAL_BLUE_6_REPEAT, (!DecalBlue6Repeat) ? 0f : 1f);
