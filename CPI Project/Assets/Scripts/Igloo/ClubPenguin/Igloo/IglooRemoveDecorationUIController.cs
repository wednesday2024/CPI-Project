...
namespace ClubPenguin.Igloo
{
	public class IglooRemoveDecorationUIController : MonoBehaviour
	{
		...
		public void Awake()
		{
			...
			{
				Debug.LogWarning("BaseCamera is null in IglooRemoveDecorationUIController.Awake()");
			}
		...
		public void OnDestroy()
		{
			...
			if (baseCamera != null)
			{
				if (baseCamera.Moved != null)
				{
					baseCamera.Moved = (System.Action)Delegate.Remove(baseCamera.Moved, new System.Action(OnCameraMoved));
				}
			}
