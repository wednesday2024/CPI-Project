...
namespace ClubPenguin.UI
{
    ...
    public class CanvasScalerExt : CanvasScaler
    {
        ...
        protected override void Start()
        {
            ...
            if (PlayerPrefs.HasKey(GetPlatformKey(SCALE_PLAYERPREFS_KEY)))
            {
                updateScaleModifier(PlayerPrefs.GetFloat(GetPlatformKey(SCALE_PLAYERPREFS_KEY)));
            }
        }
        ...
        protected override void HandleScaleWithScreenSize()
        {
            ...
            float num3 = ScaleModifierSmallDevice + (deviceSize - IPHONE5_DIAGONAL_INCHES) * num2;
