...
{
    [MenuItem("Project/Generate lighting/Lightmap baking/Events/Pirate Expedition Maze")]
    ...
    static void BakePirateExpeditionMaze()
    {
        ...
        if (activeScene.IsValid())
        {
            ...
            if (targetObject != null)
            {
                ...
                string FolderPath = "Assets/Game/World/Scenes/Events/PirateParty2018/Resources/Scenes/EventPirateParty";
