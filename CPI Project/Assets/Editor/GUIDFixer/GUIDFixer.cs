...
namespace Kamgam.GF
{
    public class GUIDFixer
    {
        ...
        [MenuItem("Project/Editor/GUID Fixer/Manual", priority = 1200)]
        public static void OpenManual()
        {
            EditorUtility.OpenWithDefaultApp("Assets/GUIDFixer/GUIDFixerManual.pdf");
        }

        [MenuItem("Project/Editor/GUID Fixer/Settings", priority = 1201)]
        public static void OpenSettings()
        {
            GUIDFixerSettings.SelectSettings();
        }

      //  [MenuItem("Project/Editor/GUID Fixer/Please leave a review  :)", priority = 1300)]
      //  public static void OpenAssetStore()
      //  {
      //      Application.OpenURL("https://assetstore.unity.com/packages/slug/230484");
      //  }

        [MenuItem("Project/Editor/GUID Fixer/Version " + GUIDFixerSettings.Version, priority = 1301)]
        ...
        [MenuItem("Project/Editor/GUID Fixer/Regenerate GUIDs for selected")]
        ...
        [MenuItem("Project/Editor/GUID Fixer/Replace GUID for selected")]
        ...
        [MenuItem("Project/Editor/GUID Fixer/Search for GUID")]
